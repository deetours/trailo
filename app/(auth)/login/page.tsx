...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginData) => {
    ...
    try {
      // Mock login for now, redirect to dashboard
      ...
      <div className="flex-1 flex items-center justify-center p-6 pb-20">
        <div className="w-full max-w-md">
          ...
          >
            <button 
              disabled
              className="w-full relative inline-flex items-center justify-center px-6 py-4 text-sm font-medium transition-colors rounded-lg outline-none bg-[#111] border border-[#222] text-[#666] cursor-not-allowed"
              title="Coming soon"
            >
            ...
            <div className="relative flex items-center py-4">
              ...
              <span className="flex-shrink-0 mx-4 text-[#444] text-xs uppercase tracking-widest">Or</span>
              <div className="flex-grow border-t border-[#222]"></div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-xs text-[#2A8AF6] hover:underline">Forgot?</a>
                </div>
                <input 
                  {...register('password')}
                  type="password"
